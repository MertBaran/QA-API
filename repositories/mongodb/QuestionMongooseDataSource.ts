...
export class QuestionMongooseDataSource implements IDataSource<IQuestionModel> {
  ...
  async findById(id: string): Promise<IQuestionModel | null> {
    try {
      ...
      throw new CustomError(
        'Database error in QuestionMongooseDataSource.findById',
        500
      );
    }
  }
  ...
  async findAll(): Promise<IQuestionModel[]> {
    try {
      ...
      throw new CustomError(
        'Database error in QuestionMongooseDataSource.findAll',
        500
      );
    }
  }
  ...
  async updateById(
    ...
    try {
      ...
      throw new CustomError(
        'Database error in QuestionMongooseDataSource.updateById',
        500
      );
    }
  }
  ...
  async deleteById(id: string): Promise<IQuestionModel | null> {
    try {
      ...
      throw new CustomError(
        'Database error in QuestionMongooseDataSource.deleteById',
        500
      );
    }
  }
  ...
  async countAll(): Promise<number> {
    try {
      ...
      throw new CustomError(
        'Database error in QuestionMongooseDataSource.countAll',
        500
      );
    }
  }
  ...
  async deleteAll(): Promise<any> {
    try {
      ...
      throw new CustomError(
        'Database error in QuestionMongooseDataSource.deleteAll',
        500
      );
    }
  }
