...
export class UserMongooseDataSource implements IDataSource<IUserModel> {
  ...
  private toEntity(mongoDoc: any): IUserModel {
    return {
      ...
      passwordChangeCode: mongoDoc.passwordChangeCode,
      passwordChangeCodeExpire: mongoDoc.passwordChangeCodeExpire,
      passwordChangeVerificationToken: mongoDoc.passwordChangeVerificationToken,
      passwordChangeVerificationTokenExpire: mongoDoc.passwordChangeVerificationTokenExpire,
      isGoogleUser: mongoDoc.isGoogleUser,
