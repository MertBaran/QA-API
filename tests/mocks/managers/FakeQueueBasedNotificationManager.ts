...
export class FakeQueueBasedNotificationManager implements INotificationService {
  constructor(
  ...
  async notify(payload: NotificationPayload): Promise<void> {
    // Mock implementation
    console.log(
      `Fake queue notification sent to ${payload.channel}: ${payload.message}`
    );
  }
  ...
  async notifyToMultipleChannels(
    ...
    // Mock implementation
    console.log(
      `Fake queue multi-channel notification sent to: ${payload.channels.join(', ')}`
    );
  }
  ...
  async notifyUser(
    ...
    // Mock implementation
    console.log(`Fake queue user notification sent to user ${userId}`);
  }
  ...
  async notifyUserWithTemplate(
    ...
    // Mock implementation
    console.log(`Fake queue template notification sent to user ${userId}`);
  }
}
